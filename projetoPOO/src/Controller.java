...
public class Controller {
        ...
        public void efetuaEncomenda(Utilizador userComprador) {
            ...
            Encomenda enc = controllerEncomenda.criaEncomenda(userComprador);
            //controllerUtlizador.addEncomendaUser(enc, userComprador);   <---- FALTA ISTO

            System.out.println("Digite o código de barras do artigo que deseja adicionar à encomenda: ");
            String codBarras = scanner.next();

            Artigo artigo = controllerArtigo.getArtigoByCod(codBarras);

            controllerEncomenda.addArtigoEncomenda(enc, artigo);
            //controllerUtlizador.removeArtigoUser(codBarras);   <---- FALTA ISTO
            ...
            while(true) {
                ...
                if(resposta.equals("N")) break;
                    ...
                    controllerEncomenda.addArtigoEncomenda(enc, artigo);
                    //controllerEncomenda.removeArtigoUser(codBarras);  <---- FALTA ISTO
                }
            }
            //controllerUtlizador.addEncomendaUser(enc, userComprador);  <---- FALTA ISTO
